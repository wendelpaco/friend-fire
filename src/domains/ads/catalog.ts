...
export const AD_CATALOG: AdCreative[] = [
  {
    ...
    placements: ["map_billboard", "lobby_banner", "pause_banner", "end_match_break"],
  },
  {
    id: "energy-rush",
    brand: "RUSH ENERGY",
    ...
    text: "#fff7ed",
    cta: "BEBA RUSH",
    placements: ["map_billboard", "map_poster", "rewarded_xp"],
  },
  {
    id: "army-recruit",
    ...
    text: "#ecfdf5",
    cta: "ENLIST NOW",
    placements: ["map_billboard", "map_poster"],
  },
  {
    id: "amigo-bet",
    brand: "AMIGO BET",
    ...
    placements: ["map_billboard", "lobby_banner", "end_match_break"],
  },
  {
    id: "ff-sponsor",
    brand: "FRIEND FIRE",
  ...
  },
  {
    ...
    text: "#f0fdfa",
    cta: "Comece grátis",
    placements: ["map_poster", "map_billboard", "pause_banner"],
  },
];
...
export function adsForPlacement(placement: AdPlacement): AdCreative[] {
  return AD_CATALOG.filter((a) => a.placements.includes(placement));
}
