...
export function SettingsPanel({ onBack }: SettingsPanelProps) {
 ...
 return (
  <div className="w-full max-w-sm border-2 border-[rgba(255,179,0,0.16)] bg-[#12151A] p-6 shadow-[0_16px_40px_rgba(0,0,0,0.7)]">
   <div className="mb-1 text-center text-[10px] font-semibold tracking-[0.3em] text-[#6F6A5B]">
    CONFIGURAÇÕES
   </div>
   ...
   <div className="flex flex-col gap-5">
    <label className="block">
     <div className="mb-2 flex items-center justify-between text-xs text-[#B9B29F]">
      <span>Volume</span>
      <span className="tabular-nums text-[#F4EFE3]">{prefs.volume}</span>
     </div>
     <input
      type="range"
      min={0}
    ...
    <label className="flex cursor-pointer items-center justify-between gap-3 border-2 border-[rgba(255,179,0,0.16)] bg-white/[0.04] px-3 py-3">
    ...
    <label className="flex cursor-pointer items-center justify-between gap-3 border-2 border-[rgba(255,179,0,0.16)] bg-white/[0.04] px-3 py-3">
     <div className="min-w-0">
      ...
      <p className="mt-0.5 text-[10px] leading-snug text-[#6F6A5B]">
    ...
    <label className="block">
     <div className="mb-2 text-xs text-[#B9B29F]">Câmera padrão</div>
     <select
      ...
      className="w-full border-2 border-[rgba(255,179,0,0.16)] bg-black/40 px-3 py-2.5 text-sm font-semibold text-[#F4EFE3] outline-none focus:border-amber-500/50"
     >
    ...
    <div className=" border-2 border-[rgba(255,179,0,0.16)] bg-white/[0.03] px-3 py-3">
     <div className="mb-3 text-[10px] font-semibold tracking-[0.2em] text-[#6F6A5B]">
      DESEMPENHO
     </div>

     <label className="block">
      <div className="mb-2 text-xs text-[#B9B29F]">
      ...
      <p className="mt-1.5 text-[10px] leading-snug text-[#6F6A5B]">
       Limite máximo; com Auto ligado o jogo pode baixar efeitos para
       manter FPS.
      </p>
     </label>

     <label className="mt-3 flex cursor-pointer items-center justify-between gap-3 border-2 border-[rgba(255,179,0,0.16)] bg-white/[0.04] px-3 py-3">
      <div>
       <span className="text-sm font-semibold text-[#F4EFE3]">
     ...
     {DEBUG_OVERLAYS && (
      <>
       ...
       <button
        type="button"
        className="mt-3 w-full border border-emerald-500/30 bg-emerald-500/10 py-2.5 text-xs font-semibold text-emerald-100/95 transition hover:bg-emerald-500/20"
        onClick={() => {
         if (typeof window === "undefined") return;
       ...
       <p className="mt-1.5 text-[10px] leading-snug text-[#6F6A5B]">
        ...
        <span className="text-[#B9B29F]">docs/performance-measurement.md</span>
        .
       </p>
      </>
     )}
   ...
   <button
    type="button"
    onClick={onBack}
    className="mt-6 w-full border-2 border-[rgba(255,179,0,0.16)] bg-white/[0.04] py-3 text-sm font-semibold text-[#F4EFE3] transition hover:bg-white/[0.08]"
   >
    Voltar
   </button>
  </div>
