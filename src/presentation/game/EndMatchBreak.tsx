...
export function EndMatchBreak({
 ...
 return (
  <div className="pointer-events-auto absolute inset-0 z-40 flex items-center justify-center bg-black/80 backdrop-blur-md">
   <div className="mx-4 w-full max-w-md overflow-hidden border-2 border-[rgba(255,179,0,0.16)] bg-[#0B0D10] shadow-[0_16px_40px_rgba(0,0,0,0.7)]">
    <div className="border-b border-white/10 px-5 py-4 text-center">
     <p className="text-[10px] font-semibold tracking-[0.3em] text-[#6F6A5B]">
      PARTIDA ENCERRADA
     </p>
     ...
     <div className="mt-3 flex items-center justify-center gap-4 text-2xl font-black tabular-nums">
      ...
      <span className="text-sm font-semibold text-[#6F6A5B]">×</span>
    ...
    {missions.length > 0 && (
     <div className="border-b border-white/10 px-4 py-3">
      <p className="mb-2 text-center text-[9px] font-bold tracking-[0.22em] text-[#6F6A5B]">
       MISSÕES DO DIA
      </p>
        ...
        return (
         <li
          ...
          className={`flex items-center justify-between gap-2 text-[11px] ${
           done ? "text-emerald-300/90" : "text-[#B9B29F]"
          }`}
         >
          ...
          <span className="shrink-0 tabular-nums text-[#6F6A5B]">
    ...
    <a
     ...
     className="relative mx-4 mt-4 block overflow-hidden border-2 border-[rgba(255,179,0,0.16)]"
     style={{
    ...
    >
     ...
     <div className="px-4 py-4">
      <div className="mb-1 flex items-center justify-between gap-2">
       ...
       <span className="rounded bg-black/35 px-1.5 py-0.5 text-[9px] font-semibold tracking-wider text-[#B9B29F]">
        AD
       </span>
      </div>
    ...
    <div className="flex flex-col gap-2 p-4">
     <button
      ...
      className=" border-2 border-[#FFB300]/40 bg-amber-500/15 py-2.5 text-sm font-bold tracking-wide text-amber-200 transition hover:bg-amber-500/25 disabled:cursor-not-allowed disabled:opacity-50"
     >
      {rewardDone
     ...
     <button
      ...
      disabled={rewardBusy}
      className=" bg-amber-500 py-3 text-sm font-bold tracking-wide text-black transition hover:bg-amber-400 disabled:cursor-not-allowed disabled:opacity-50"
     >
      Continuar
