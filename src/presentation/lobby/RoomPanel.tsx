...
export function RoomPanel({
 ...
 return (
  ...
  >
   <div className="w-full max-w-lg border-2 border-[rgba(255,179,0,0.20)] bg-[#12151A] p-6 shadow-[0_16px_40px_rgba(0,0,0,0.7)]">
    <div className="mb-1 flex items-start justify-between gap-3">
     ...
     <button
      type="button"
      onClick={handleClose}
      className=" border-2 border-[rgba(255,179,0,0.16)] px-2.5 py-1 text-sm text-[#B9B29F] transition hover:bg-white/[0.04] hover:text-white"
      aria-label="Fechar"
     >
      ✕
     </button>
    ...
    {mode === "create" ? (
     <div className="mt-5">
      {createdCode ? (
       <>
        <p className="text-sm text-[#B9B29F]">
         Compartilhe este código com seus amigos:
        </p>
        <div className="mt-3 border-2 border-[#FFB300]/40 bg-amber-500/10 px-4 py-4 text-center">
         <div className="font-mono text-3xl font-black tracking-[0.35em] text-amber-200">
          {createdCode}
         </div>
        </div>
        <p className="mt-3 text-xs text-[#6F6A5B]">
         Mapa:{" "}
        ...
        <div className="mt-5 flex flex-col gap-2">
         <button
          ...
          className=" bg-amber-500 py-3 text-sm font-bold tracking-wide text-black transition hover:bg-amber-400"
         >
          Entrar na sala
         </button>
         ...
         <button
          ...
          className=" border-2 border-[rgba(255,179,0,0.16)] bg-white/[0.04] py-3 text-sm font-semibold text-[#F4EFE3] transition hover:bg-white/[0.08]"
         >
          Copiar código
         </button>
        </div>
       ...
       <>
        <p className="text-sm leading-relaxed text-[#B9B29F]">
        ...
        <p className="mt-4 text-[10px] font-semibold uppercase tracking-[0.2em] text-[#6F6A5B]">
         Mapa
        </p>
        <div
         ...
         {CREATE_MAPS.map((m) => {
          ...
          return (
           <button
            ...
            className={`relative min-h-[5.5rem] overflow-hidden border p-3 text-left transition ${
             selected
              ? "border-white/40 shadow-[0_8px_24px_rgba(0,0,0,0.6)] ring-1 ring-white/20"
           ...
           >
            ...
            {m.blurb ? (
             <span className="mt-1 block text-[11px] leading-snug text-[#B9B29F]">
              {m.blurb}
             </span>
            ) : null}
            {selected ? (
        ...
        <label
         ...
         className="mt-3 block text-[10px] font-semibold uppercase tracking-[0.2em] text-[#6F6A5B]"
        >
        ...
        <input
         ...
         className="mt-2 w-full border-2 border-[rgba(255,179,0,0.20)] bg-black/50 px-4 py-3 text-sm text-[#F4EFE3] outline-none placeholder:text-[#6F6A5B] focus:border-amber-400/60"
        />

        <label className="mt-4 flex cursor-pointer items-center justify-between gap-3 border-2 border-[rgba(255,179,0,0.16)] bg-black/30 px-4 py-3">
         <span>
          <span className="block text-sm font-semibold text-[#F4EFE3]">
           Sala pública
          </span>
          <span className="mt-0.5 block text-[11px] text-[#6F6A5B]">
           {isPublic
        ...
        {error && (
         <p className="mt-3 border-2 border-[#FF3B30]/30 bg-red-950/40 px-3 py-2 text-sm text-red-300">
          {error}
         </p>
        )}
        <div className="mt-5 flex flex-col gap-2">
         <button
          ...
          className=" bg-amber-500 py-3 text-sm font-bold tracking-wide text-black transition hover:bg-amber-400 disabled:opacity-50"
         >
         ...
         <button
          type="button"
          onClick={handleClose}
          className=" border-2 border-[rgba(255,179,0,0.16)] bg-white/[0.04] py-3 text-sm font-semibold text-[#B9B29F] transition hover:bg-white/[0.08]"
         >
          Cancelar
         </button>
        </div>
     ...
     <div className="mt-5">
      <label
       ...
       className="text-[10px] font-semibold uppercase tracking-[0.2em] text-[#6F6A5B]"
      >
       Código da sala
      </label>
      <input
       ...
       className="mt-2 w-full border-2 border-[rgba(255,179,0,0.20)] bg-black/50 px-4 py-3 text-center font-mono text-2xl font-bold tracking-[0.35em] text-amber-100 outline-none placeholder:text-white/20 focus:border-amber-400/60"
      />
      <p className="mt-2 text-xs text-[#6F6A5B]">
       6 caracteres · sem O, 0, I ou 1
      </p>
      {error && (
       <p
        role="alert"
        className="mt-3 border-2 border-[#FF3B30]/30 bg-red-950/40 px-3 py-2 text-sm text-red-300"
       >
        {error}
       </p>
      )}
      <div className="mt-5 flex flex-col gap-2">
       <button
        ...
        className=" bg-amber-500 py-3 text-sm font-bold tracking-wide text-black transition hover:bg-amber-400 disabled:cursor-not-allowed disabled:opacity-45"
       >
